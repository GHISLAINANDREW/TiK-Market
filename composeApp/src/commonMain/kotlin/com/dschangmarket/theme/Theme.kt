...
val BrandGradient = Brush.horizontalGradient(listOf(Color(0xFF1B5E20), Color(0xFFE65100)))
val BrandTopBarColor = Color(0xFF2E4D23) // Vert-Orange sombre (mélange olive)
