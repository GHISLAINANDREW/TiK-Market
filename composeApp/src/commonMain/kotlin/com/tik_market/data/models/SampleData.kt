...
object SampleData {
    ...
    val products = listOf(
        Product("p1", "shop1", "Ferme Avicole de Dschang", "Quartier Foto", "v1", "+237 690 00 00 01",
        ...
        Product("p2", "shop1", "Ferme Avicole de Dschang", "Quartier Foto", "v1", "+237 690 00 00 01",
        ...
        Product("p3", "shop2", "Tissus & Mode Dschang", "Marché A", "v2", "+237 690 00 00 02",
        ...
        Product("p4", "shop2", "Tissus & Mode Dschang", "Marché A", "v2", "+237 690 00 00 02",
        ...
        Product("p5", "shop2", "Tissus & Mode Dschang", "Marché A", "v2", "+237 690 00 00 02",
        ...
        Product("p6", "shop3", "Electro-Dschang", "Centre-ville", "v3", "+237 690 00 00 03",
        ...
        Product("p7", "shop3", "Electro-Dschang", "Centre-ville", "v3", "+237 690 00 00 03",
        ...
        Product("p8", "shop1", "Ferme Avicole de Dschang", "Quartier Foto", "v1", "+237 690 00 00 01",
        ...
        Product("p9", "shop3", "Electro-Dschang", "Centre-ville", "v3", "+237 690 00 00 03",
        ...
        Product("p10", "shop2", "Tissus & Mode Dschang", "Marché A", "v2", "+237 690 00 00 02",
    ...
    val shops = listOf(
        Shop("shop1", "v1", "Ferme Avicole de Dschang", "Produits avicoles de qualité depuis 2015. Élevage en plein air.", "", "+237 690 00 00 01", "Quartier Foto", "Alimentation", 4.8f, 3, true),
        Shop("shop2", "v2", "Tissus & Mode Dschang", "Vente de tissus traditionnels et confection sur mesure. Le choix pour vos cérémonies.", "", "+237 690 00 00 02", "Marché A", "Mode", 4.7f, 4, true),
        Shop("shop3", "v3", "Electro-Dschang", "Appareils électroniques neufs sous garantie. Livraison à Dschang et environs.", "", "+237 690 00 00 03", "Centre-ville", "Électronique", 4.5f, 3, true)
    )
